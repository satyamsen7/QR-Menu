<?php
// Standalone public logo file - no includes, no routing

// Get username from URL parameter
$username = $_GET['username'] ?? '';
$username = trim(preg_replace('/[^a-zA-Z0-9_\-]/', '', $username)); // Basic sanitization
...
$password = 'vUj3t1ckZKJzmi'; // ✅ FIXED PASSWORD STRING QUOTES

try {
    $db = new PDO("mysql:host=$host;dbname=$db_name;charset=utf8mb4", $username_db, $password);
